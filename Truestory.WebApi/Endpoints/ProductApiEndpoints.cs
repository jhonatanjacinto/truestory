...
public static class ProductApiEndpoints
{
    ...
    private static async Task<IResult> PostProductAsync(CreateProductDTO createProductDto, ProductExternalApiService productExternalApiService, TruestoryDbContext context)
    {
        try
        {
    ...
    private static async Task<IResult> PatchProductAsync(string id, PatchProductDTO productToUpdateDto, ProductExternalApiService productExternalApiService, TruestoryDbContext context)
    {
        try
        {
    ...
    private static async Task<IResult> DeleteProductAsync(string id, ProductExternalApiService productExternalApiService, TruestoryDbContext context)
    {
        try
        {
    ...
    private static async Task<IResult> PutProductAsync(string id, UpdateProductDTO productToUpdateDto, ProductExternalApiService productExternalApiService, TruestoryDbContext context)
    {
        try
        {
